...
public class MRTStationSelectorSource extends Activity {

    int selectedstation;
    int selectedline;
    private Spinner spinner;
    private Spinner spinner2;
    private String selectedstn_source = "Aljunied";
    ...
    public void onCreate(Bundle savedInstanceState) {
                    ...
                    case 0:
                        ...
                        spinner2.setOnItemSelectedListener(new OnItemSelectedListener() {
                            public void onItemSelected(AdapterView<?> parent, View view,
                                                       int pos, long id) {
                                int position = 0;
                                selectedstn_source = (String) parent.getItemAtPosition(pos);
                            }
        ...
        returnBtn.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra("selectedstn_source", selectedstn_source);
                setResult(1, intent);

                //DESTROYING STATION SELECTOR ACTIVITY AND RETURNING TO MAIN ACTIVITY
                MRTStationSelectorSource.this.finish();
            }
        });
    }
